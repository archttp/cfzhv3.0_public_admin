<template>
  <div class="container">
    <a-modal v-model:visible="visible" :width="1000" draggable :footer="false" @close="resetFields" id="printBox">
      ...
      <a-row>
        <a-col :flex="1">
          <a-form :model="formModel" :label-col-props="{ span: 6 }" :wrapper-col-props="{ span: 18 }" label-align="left">
            <a-row :gutter="18">
              ...
              <a-col :span="8">
                <a-form-item label="业务:" field="status">
                  <a-select
        ...
        <a-divider v-if="showPrint" style="height: 40px" direction="vertical" />
        <a-col v-if="showPrint" :flex="'86px'" style="text-align: right">
      ...
      <a-row>
        <a-col :flex="1">
          <a-form :model="formModel" :label-col-props="{ span: 6 }" :wrapper-col-props="{ span: 18 }" label-align="left">
            <a-row :gutter="24">
              <a-col :span="8">
                <a-form-item label="制表人:">
                  <a-input v-model="trueName" placeholder=""/>
                </a-form-item>
              </a-col>
              <a-col :span="8">
              ...
              <a-col :span="8">
                <a-button v-if="showPrint" type="primary" status="warning" @click="printOrder">打印</a-button>
              </a-col>
            </a-row>
          </a-form>
        </a-col>
