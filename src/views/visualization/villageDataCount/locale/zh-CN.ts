export default {
  ...
  'dataAnalysis.title.publicOpinion': '基本信息',
  ...
  'dataAnalysis.contentPeriodAnalysis': '停车总览(月数据)',
  'dataAnalysis.contentChargingPeriodAnalysis': '充电总览(月数据)',
  'dataAnalysis.contentVillagePeriodAnalysis': '社区总览(月数据)',
};
