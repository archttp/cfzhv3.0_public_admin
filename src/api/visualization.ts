...
export function getDailyParkingStatistcsListByQuery(params: any) {
  return axios.get<any>(
    '/internetOfThingsAdmin/cfCarPark/getDailyParkingStatistcsListByQuery',
    params
  );
}
export function getDailyChargingStatistcsListByQuery(params: any) {
  return axios.get<any>(
    '/internetOfThingsAdmin/cfChargingStation/getDailyChargingStatistcsListByQuery',
    params
  );
}
export function getDailyVillageStatistcsListByQuery(params: any) {
  return axios.get<any>(
    '/wisdomCommunityAdmin/cfVillage/getDailyVillageStatistcsListByQuery',
    params
  );
}

export function getDailyIncomeStatisticsListByQuery(params: any) {
  return axios.get<any>(
    '/payAdmin/cfAccount/getDailyIncomeStatisticsListByQuery',
    params
  );
}
